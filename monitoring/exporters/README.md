...
- `benchmark-results-exporter`: publica CSV/JSON ja gerados como series para Grafana, sem instrumentar as APIs. Na metodologia 6 oficial, aceita CPU e memoria somente de `cadvisor_summary.csv`, exige `postgres_summary.csv` para os recursos da rodada e mantem `docker_stats_summary.csv` restrito a pilotos e legado.
