...
class ResultsExporterTests(unittest.TestCase):
    ...
    def test_exports_consolidated_and_live_metrics(self) -> None:
        ...
        self.assertIn('benchmark_result_confidence{classification="official",language="python",load_profile="controlled_50",methodology="6",scenario="mixed",status="adequate",users="50"} 1', output)
        self.assertIn('benchmark_result_throughput_rps{classification="official",language="python",load_profile="controlled_50",methodology="6",scenario="mixed",stat="median",users="50"} 102', output)
        self.assertIn('benchmark_run_throughput_rps{classification="official",language="python",load_profile="controlled_50",methodology="6",run="1",scenario="mixed",users="50"} 100', output)
        self.assertIn('benchmark_endpoint_latency_ms{classification="official",endpoint="GET /customers"', output)
        self.assertIn('metric_source="cadvisor_via_prometheus"', output)
        self.assertIn('benchmark_result_postgres_connections{classification="official",language="python"', output)
